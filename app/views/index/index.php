	<div id="titulo">
		...
		<ul id="submenu">
			<li><?php  echo $this->html->linkTo($this->l10n->__("What is sabros.us lite?"), "index/what/", "title=\"".$this->l10n->__("What is sabros.us lite?")."\""); ?></li>
	...
	<div id="indicador_pagina"><?php echo $this->l10n->__("There are") ?> <strong><?php echo $totalRows; ?></strong> <?php echo $this->l10n->__("links. Showing from") ?> <strong><?php echo $from; ?></strong> <?php echo $this->l10n->__("to") ?> <strong><?php echo $to; ?></strong></div>
